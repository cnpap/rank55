var VTJump = (function () {
  ...
  var root_3 = /* @__PURE__ */ template(
    `<div class="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-[9999] animate-in fade-in slide-in-from-bottom-4 duration-300"><div class="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 border border-gray-200 dark:border-gray-700 backdrop-blur-sm px-4 py-3 flex items-center gap-3"><svg class="w-5 h-5 text-green-500 dark:text-green-500/80 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clip-rule="evenodd"></path></svg> <span class="text-sm font-medium"> </span></div></div>`
  );
